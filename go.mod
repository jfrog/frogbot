...
require (
	...
	github.com/jfrog/froggit-go v1.14.4
...
replace github.com/jfrog/jfrog-cli-core/v2 => github.com/omerzi/jfrog-cli-core/v2 v2.15.3-0.20231213093403-abe74b2a3195
