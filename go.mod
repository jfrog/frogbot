...
require (
	...
	github.com/jfrog/froggit-go v1.9.0
...
replace github.com/jfrog/jfrog-cli-core/v2 => github.com/eyaldelarea/jfrog-cli-core/v2 v2.0.0-20230723081014-18402be519cd
