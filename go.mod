...
require (
	...
	github.com/jfrog/jfrog-cli-security v1.8.1
...
replace github.com/jfrog/jfrog-cli-security => github.com/eranturgeman/jfrog-cli-security v0.0.0-20240915175227-413008337843
