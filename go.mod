...
require (
	...
	github.com/jfrog/froggit-go v1.5.2
...
replace github.com/jfrog/jfrog-cli-core/v2 => github.com/omerzi/jfrog-cli-core/v2 v2.15.3-0.20230119094234-85d7f49c49bf
