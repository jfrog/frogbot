...
func TestGetSecretsEmailContent(t *testing.T) {
	...
	expected = "\n<!DOCTYPE html>\n<html>\n<head>\n    <title>Frogbot Secret Detection</title>\n    <style>\n        body {\n            font-family: Arial, sans-serif;\n            background-color: #f5f5f5;\n        }\n        table {\n            border-collapse: collapse;\n            width: 80%;\n        }\n        th, td {\n            padding: 10px;\n            border: 1px solid #ccc;\n        }\n        th {\n            background-color: #f2f2f2;\n        }\n        tr:nth-child(even) {\n            background-color: #f9f9f9;\n        }\n        tr:hover {\n            background-color: #f5f5f5;\n        }\n        .table-container {\n            max-width: 700px;\n            padding: 20px;\n            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n            border-radius: 10px;\n            overflow: hidden;\n            background-color: #fff;\n\t\t\tmargin-top: 10px;\n        }\n        .ignore-comments {\n            margin-top: 10px;\n\t\t\tmargin-bottom: 5px;\n            border-radius: 5px;\n        }\n    </style>\n</head>\n<body>\n\t<div>\n\t\tThe following potential exposed secrets in your <a href=\"https://github.com/owner/repo/pullrequest/1\">merge request</a> have been detected by <a href=\"https://jfrog.com/help/r/jfrog-security-user-guide/shift-left-on-security/frogbot\">Frogbot</a>\n\t\t<br/>\n\t\t<table class=\"table-container\">\n            <thead>\n                <tr>\n                    <th>FILE</th>\n                    <th>LINE:COLUMN</th>\n                    <th>SECRET</th>\n                </tr>\n            </thead>\n            <tbody>\n                \n\t\t\t\t<tr>\n\t\t\t\t\t<td> /config.yaml </td>\n\t\t\t\t\t<td> 12:30 </td>\n\t\t\t\t\t<td> pass***** </td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td> /server-conf.json </td>\n\t\t\t\t\t<td> 15:20 </td>\n\t\t\t\t\t<td> pass***** </td>\n\t\t\t\t</tr>\n            </tbody>\n        </table>\n\t\t<div class=\"ignore-comments\">\n\t\t<b>NOTE:</b> If you'd like Frogbot to ignore the lines with the potential secrets, add a comment that includes the <b>jfrog-ignore</b> keyword above the lines with the secrets.\t\n\t\t</div>\n\t</div>\n</body>\n</html>"
