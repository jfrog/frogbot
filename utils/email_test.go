	...
	secrets := []formats.SourceCodeRow{
		{SeverityDetails: formats.SeverityDetails{Severity: "High"},
			SourceCodeLocationRow: formats.SourceCodeLocationRow{
				File: "/config.yaml", LineColumn: "12:30", Snippet: "pass*****"},
		},
		{SeverityDetails: formats.SeverityDetails{Severity: "Medium"}, SourceCodeLocationRow: formats.SourceCodeLocationRow{
			File: "/server-conf.json", LineColumn: "15:20", Snippet: "pass*****"}},
	}
