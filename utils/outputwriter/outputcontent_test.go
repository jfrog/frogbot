			...
			cases: []OutputTestCase{
				{
					...
					writer:             GetTestWriter(WriterPR, false, false, ""),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterPR, true, false, ""),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterMR, false, false, ""),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterMR, true, false, ""),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterSimplified, false, false, ""),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterSimplified, true, false, ""),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterPR, false, false, "Custom title"),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterPR, false, true, "Custom title"),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterSimplified, false, false, "Custom title"),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterMR, false, true, ""),
					expectedOutputPath: filepath.Join(testSummaryCommentDir, "structure", "summary_comment_no_issues_mr_entitled.md"),
				},
			},
		},
		{
			...
			cases: []OutputTestCase{
				...
				},
				{
					...
					writer:             GetTestWriter(WriterPR, false, true, ""),
					expectedOutputPath: filepath.Join(testSummaryCommentDir, "structure", "summary_comment_issues_pr_entitled.md"),
				},
				{
					name:               "Simplified output not entitled avoid extra messages",
					writer:             GetTestWriter(WriterSimplified, false, true, ""),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterMR, true, false, "Custom title"),
				...
				},
				{
					...
					writer:             GetTestWriter(WriterSimplified, true, false, "Custom title"),
