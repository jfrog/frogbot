...
func TestGetSecretsEmailContent(t *testing.T) {
	...
	repo := &Repository{
		Params: Params{
			Git: Git{PullRequestDetails: vcsclient.PullRequestInfo{URL: "https://github.com/owner/repo/pullrequest/1"}},
		},
		OutputWriter: &outputwriter.StandardOutput{},
	}
	// Test for results including the "Pull Request" keyword
	repo.SetVcsProvider(vcsutils.GitHub)
