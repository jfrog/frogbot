...
func TestCreateXrayScanParams(t *testing.T) {
	...
	scanDetails.SetXrayGraphScanParams(nil, "", nil)
	...
	// Watches
	scanDetails.SetXrayGraphScanParams([]string{"watch-1", "watch-2"}, "", nil)
	...
	// Project
	scanDetails.SetXrayGraphScanParams(nil, "project", nil)
	assert.Empty(t, scanDetails.Watches)
