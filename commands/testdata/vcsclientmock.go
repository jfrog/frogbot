...
func (m *MockVcsClient) ListOpenPullRequests(arg0 context.Context, arg1, arg2 string) ([]vcsclient.PullRequestInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListOpenPullRequests", arg0, arg1, arg2)
	ret0, _ := ret[0].([]vcsclient.PullRequestInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListOpenPullRequests indicates an expected call of ListOpenPullRequests.
func (mr *MockVcsClientMockRecorder) ListOpenPullRequests(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListOpenPullRequests", reflect.TypeOf((*MockVcsClient)(nil).ListOpenPullRequests), arg0, arg1, arg2)
}

// ListPullRequestComments mocks base method.
func (m *MockVcsClient) ListPullRequestComments(arg0 context.Context, arg1, arg2 string, arg3 int) ([]vcsclient.CommentInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPullRequestComments", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]vcsclient.CommentInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListPullRequestComments indicates an expected call of ListPullRequestComments.
func (mr *MockVcsClientMockRecorder) ListPullRequestComments(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPullRequestComments", reflect.TypeOf((*MockVcsClient)(nil).ListPullRequestComments), arg0, arg1, arg2, arg3)
}
