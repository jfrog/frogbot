...
<img src="../../../images/jenkins-pipeline-select.png"> Create a new pipeline with the following jenkinsfile: 
...
<img src="../../../images/jenkins-pipeline-select.png"> Create a new Jenkins pipeline with the following jenkinsfile:
