...
const (
	SecurityIssueFoundErr = "issues were detected by Frogbot\n" +
		...
		"Note that even if failOnSecurityIssues/" + utils.FailOnSecurityIssuesEnv + " are set to false, but a security violation with 'fail-pr' rule is found, Frogbot scan will fail as well"
