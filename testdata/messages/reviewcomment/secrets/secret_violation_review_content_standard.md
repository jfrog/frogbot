...
| :---------------------: | :-----------------------------------: |:-----------------------------------: | :-----------------------------------: |
| ![](https://raw.githubusercontent.com/jfrog/frogbot/master/resources/v2/applicableMediumSeverity.png)<br>  Medium | VIOLATION_ID  | Secret keys were found | Active |
...
__CWE:__| CWE-89
__Abbreviation:__| java-sql-injection
