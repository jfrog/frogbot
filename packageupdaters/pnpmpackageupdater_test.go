...
func TestPnpmCollectVulnerabilityDescriptorPaths_filtersCoordinateEvidence(t *testing.T) {
	t.Parallel()
	...
	paths := pnpm.CollectVulnerabilityDescriptorPaths(vuln, []string{nodePackageJSONFileName}, []string{nodeModulesDirName})
